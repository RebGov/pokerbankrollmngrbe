class Api::V1::PlayedGamesController < ApplicationController
  ...
  def played_games_params
    params.permit(:id, :user_id, :start_date_time, :end_date_time, :buy_in, :cash_out, :game_location_id, :game_name_id, :blinds_name_id, :tournament, :tournament_placement, :notes_id, :profit, :minutes, :won_game)
  end
end
